  ...
  <main className="projects-container">
    ...
    <div className="project-entry">
      ...
      <div className="project-image">
        <img src={process.env.PUBLIC_URL + '/p1.png'} alt="Aurum Jewelry PH" />
      </div>
    </div>
    ...
    <div className="project-entry">
      <div className="project-text">
        ...
        <p className="project-description">
          ...
          <a
            href="https://cruisingcartss-team.adalo.com/try?target=818468a1bfad492599706dafa106d579&params=%7B%7D"
            target="_blank"
      ...
      <div className="project-image">
        <img src={process.env.PUBLIC_URL + '/p2.png'} alt="Cruising Carts" />
      </div>
    </div>
  </main>
);
